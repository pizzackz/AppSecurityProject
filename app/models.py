...
class User(db.Model, UserMixin):
    ...
    account_status = db.relationship("AccountStatus", backref="user", uselist=False)
    login_details = db.relationship("LoginDetails", backref="user", uselist=False)
    locked_accounts = db.relationship("LockedAccount", backref="user", cascade="all, delete-orphan")
...
class Admin(db.Model, UserMixin):
    ...
    # def __repr__(self):
    #     return f"Admin('{self.user.username}', '{self.master_key}')"
...
class Member(db.Model, UserMixin):
    ...
    # def __repr__(self):
    #     return f"Member('{self.user.username}', '{self.subscription_plan}')"
...
class LockedAccount(db.Model):
    ...
    locker = db.relationship("Admin", backref="locked_accounts")
